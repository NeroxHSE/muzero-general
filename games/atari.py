...
class MuZeroConfig:
    def __init__(self):
        ...
        self.training_steps = int(18)  # Total number of training steps (ie weights update according to a batch)
        self.batch_size = 1024  # Number of parts of games to train on at each training step
        self.checkpoint_interval = int(1)  # Number of training steps before using the model for self-playing
        ...
        self.lr_decay_steps = 350



        ### Replay Buffer
        self.replay_buffer_size = int(100)  # Number of self-play games to keep in the replay buffer
