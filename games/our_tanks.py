...
from PyTanks.data.game_func import GameFunc
from PyTanks.data.settings import Settings
...
class Game(AbstractGame):
    ...
    def step(self, action):
        ...
        observation, reward, done = self.env.nextStep(players[0], action)
    ...
    def action_to_string(self, action_number):
        ...
        """
        return self.env.action_to_string()